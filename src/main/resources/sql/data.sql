INSERT INTO `user` (`user_name`,`email`,`password`,`date_of_birth`,`is_public`) VALUES ('test_user','test_user@gmail.com','1234','2000-01-02 12:00:00','Y');
INSERT INTO `user` (`user_name`,`email`,`password`,`date_of_birth`,`is_public`) VALUES ('1q2w3e4r','1q2w3e4r@gmail.com','1234','2000-01-02 12:00:00','Y');
